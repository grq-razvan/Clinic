...
public class SecretaryAddPatientPage extends Window {
	...
	public SecretaryAddPatientPage(){
		...
		Component[] labels = {nameLabel,cnpLabel,dateLabel,addressLabel,cardLabel};
	...
	private void addListeners() {
		...
		submit.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {					
					Patient p = new Patient(Integer.parseInt(cardNumber
							.getText()), cnp.getText(), name.getText(), address
							.getText(), new SimpleDateFormat("dd/MM/yyyy")
							.parse(date.getText()));
